...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="search-container">
        ...
        <asp:Button ID="btn_BuscarSesion" runat="server" Text="Buscar" CssClass="btn btn-info" />
        <asp:Button ID="btn_ListarSesiones" runat="server" Text="Listar Todas" CssClass="btn btn-success" />
    </div>
